...
<div class="padding">
    ...
    <div class="ui grid">
        <div class="row">
            <div class="column">
                <div class="ui buttons">
                    <a class="ui small blue button" href="contestrank.php?cid=<?php echo $view_cid?>">ACM차트</a>
                    <a class="ui small yellow button" href="contestrank-oi.php?cid=<?php echo $view_cid?>">OI차트</a>
                    <a class="ui small positive button" href="status.php?cid=<?php echo $view_cid?>">제출기록</a>
                ...
                <div class="ui buttons right floated">
                    ...
                    <?php
          if ($now>$end_time)
          echo "<span class=\"ui small button grey\">대회종료</span>";
          else if ($now<$start_time)
          echo "<span class=\"ui small button red\">미개시</span>";
          else
          echo "<span class=\"ui small button green\">진행중</span>";
          ?>
                    <?php
          if ($view_private=='0')
          echo "<span class=\"ui small button blue\">Public</span>";
          else
          echo "<span class=\"ui small button pink\">Private</span>";
          ?>
        ...
        <div class="row">
            <div class="column">
                <h4 class="ui top attached block header">정보 공개</h4>
                ...
                <table class="ui selectable celled table">
                    <thead>
                        <tr>
                            ...
                            <th class="two wide" style="text-align: center">제목번호</th>
                            <th>제목</th>
                            <th>분류</th>
                            <th class="one wide center aligned">정확</th>
